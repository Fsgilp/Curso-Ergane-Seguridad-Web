...
function enviar(){
	//'<form action="http://localhost:8091/Ej08_XSS_EjemplosAtaque_Indeseables/peticion_inocente" method="post">'+
	let parametros = "login="+document.getElementById('login_').value+"&pw="+document.getElementById('pw_').value
	xmlhttp = new XMLHttpRequest();
	xmlhttp.open("post", "http://localhost:8091/Ej08_XSS_EjemplosAtaque_Indeseables/peticion_inocente?"+parametros,false);
	xmlhttp.send();
