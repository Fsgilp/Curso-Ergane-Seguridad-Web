...
public class ServicioEmpleados extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			 ...
			 * System.out.println("Inyección!!!"); //devolvemos un 400, problema del cliente
			 * response.sendError(HttpServletResponse.SC_BAD_REQUEST,"INYECCION!!!!"); //
			 * Que hacemos si detectamos una inyección? // ->No seguir y mandar al usuario a
			 * login. // Y escribir en un log lo que ha pasado //ya que es posible que
			 * suframos más ataques y conviene //estar prevenidos return; }
			 */
